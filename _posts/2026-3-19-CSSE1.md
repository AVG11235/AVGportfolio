...
<div style="display: flex; align-items: center; gap: 20px; margin-bottom: 30px;">
  ...
  <!-- The Image -->
  <img src="/home/ubuntu/AVG11235/AVGportfolio/images/AReview/term.png" alt="terminal" style="border-radius: 15px; max-width: 60%; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
...
<div style="display: flex; align-items: center; gap: 20px; margin-bottom: 30px;">
  ...
  <!-- The Image -->
  <img src="/home/ubuntu/AVG11235/AVGportfolio/images/AReview/vscode.png" alt="vscode" style="border-radius: 15px; max-width: 60%; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
  
  <!-- The Text on the Side -->
  <div style="flex: 1;">
    <p> cool vscode showcase being in also showing the vscode terminal </p>
  </div>
...
The situation is that across a team assignment where we also learned hw to work in a repo all together syncing up, stashing, and commiting while working on multiple files together, I was able to get the copilot AI to change all the instances of red to purple and yellow to orange in a connect 4 game, leading to a noticable color change in the game, it wasn't a massive change but it showed an ability to edit in a semi-successful way. 

## Second teaching in a subject: The JSON and javascript objects

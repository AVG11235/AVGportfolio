...
<div style="display: flex; align-items: center; gap: 20px; margin-bottom: 30px;">
  ...
  <!-- The Image -->
  <img src="term.png" alt="Image description" style="border-radius: 15px; max-width: 60%; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
...
<div style="display: flex; align-items: center; gap: 20px; margin-bottom: 30px;">
  ...
  <!-- The Image -->
  <img src="vscode.png" alt="Image description" style="border-radius: 15px; max-width: 60%; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
